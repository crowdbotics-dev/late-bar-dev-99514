"""
Django settings for late_bar_dev_99514 project.
...
ROOT_URLCONF = 'late_bar_dev_99514.urls'
...
WSGI_APPLICATION = 'late_bar_dev_99514.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "late_bar_dev_99514 API",
    "DESCRIPTION": "API documentation for late_bar_dev_99514 App",
    "VERSION": "v1",
}
